...
* Optionally, install the development version of `XGR` package (now hosted in *GitHub* [^2]):
```{r eval=F}
...
# find maximum-scoring gene subnetwork with the desired node number=30
subnet_IBD <- xSubneterSNPs(data=data, network="STRING_high", distance.max=500000, seed.genes=T, subnet.size=30)
```
